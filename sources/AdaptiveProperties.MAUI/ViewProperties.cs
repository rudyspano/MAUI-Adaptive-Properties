...
namespace AdaptiveProperties.MAUI.M;
  ...
  public static class V
  {
    ...
    private static void RowChanged(BindableObject bindable, object oldvalue, object newvalue)
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, true, "V");
    }
    ...
    private static void HeightRequestChanged(BindableObject bindable, object oldvalue, object newvalue)
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, true, "V");
    }
    ...
    private static void IsVisibleChanged(BindableObject bindable, object oldvalue, object newvalue)
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, true, "V");
    }
    ...
    private static void SpacingChanged(BindableObject bindable, object oldvalue, object newvalue)
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, true, "V");
    }
    ...
    private static void RowSpacingChanged(BindableObject bindable, object oldvalue, object newvalue)
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, true, "V");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, true, "V");
    }
    ...
    private static void CornerRadiusChanged(BindableObject bindable, object oldvalue, object newvalue)
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, true, "V");
    }
}
  /// <summary>
  ...
  public static class H
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, true, "H");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, true, "H");
    }
}
  /// <summary>
  /// Phone Vertical mode
  ...
  public static class PV
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, true, "PV");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, true, "PV");
    }
}
  /// <summary>
  ...
  public static class PH
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, true, "PH");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, true, "PH");
    }
}
  /// <summary>
  ...
  public static class TV
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, true, "TV");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, true, "TV");
    }
}
  /// <summary>
  ...
  public static class TH
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, true, "TH");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, true, "TH");
    }
}
  /// <summary>
  ...
  public static class X
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, false, "X");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, false, "X");
    }
}
  /// <summary>
  /// Custom mode to set and trigger via SetModeActivationChecking and TriggerModeActivationChecking methods
  ...
  public static class X2
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, false, "X2");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, false, "X2");
    }
}
  /// <summary>
  /// Custom mode to set and trigger via SetModeActivationChecking and TriggerModeActivationChecking methods
  ...
  public static class X3
  {
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRow(view); Grid.SetRow(view,value); return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumn(view); Grid.SetColumn(view,value); return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetRowSpan(view); Grid.SetRowSpan(view,value); return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, int>.ListenProperty(bindable, newvalue, CheckFunc,
        (view, value) => { var previousValue = Grid.GetColumnSpan(view); Grid.SetColumnSpan(view,value); return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.HeightRequest; view.HeightRequest = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.WidthRequest; view.WidthRequest = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumHeightRequest; view.MinimumHeightRequest = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.MinimumWidthRequest; view.MinimumWidthRequest = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, bool>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.IsVisible; view.IsVisible = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<View, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Opacity; view.Opacity = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<StackBase, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.Spacing; view.Spacing = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.RowSpacing; view.RowSpacing = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<Grid, double>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.ColumnSpacing; view.ColumnSpacing = value; return (true, previousValue); }, false, "X3");
    }
    ...
    {
      PropertyDefinition<Frame, float>.ListenProperty(bindable, newvalue, CheckFunc,
        (view,value) => { var previousValue = view.CornerRadius; view.CornerRadius = value; return (true, previousValue); }, false, "X3");
    }
}
